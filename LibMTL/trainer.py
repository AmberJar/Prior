...
class Trainer(nn.Module):
    ...
    Args:
        ...
        weighting (class): A weighting strategy class based on :class:`LibMTL-main.weighting.abstract_weighting.AbsWeighting`.
        architecture (class): An architecture class based on :class:`LibMTL-main.architecture.abstract_arch.AbsArchitecture`.
    ...
    .. note::
            It is recommended to use :func:`LibMTL-main.config.prepare_args` to return the dictionaries of ``optim_param``, \
            ``scheduler_param``, and ``kwargs``.

    Examples::
        
        import torch.nn as nn
        from LibMTL-main import Trainer
        from LibMTL-main.loss import CE_loss_fn
        from LibMTL-main.metrics import acc_update_fun, acc_score_fun
        from LibMTL-main.weighting import EW
        from LibMTL-main.architecture import HPS
        from LibMTL-main.model import ResNet18
        from LibMTL-main.config import prepare_args
